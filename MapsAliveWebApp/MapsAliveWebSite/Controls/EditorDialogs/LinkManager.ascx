	...
	<tr>
		<td class="reTopcell">
			<telerik:RadTabStrip ShowBaseLine="true" ID="LinkManagerTab" runat="server" SelectedIndex="0" MultiPageID="dialogMultiPage">
				<Tabs>
					<telerik:RadTab Text="HyperlinkTab" PageViewID="hyperlinkFieldset" Value="HyperlinkTab">
					</telerik:RadTab>
					<telerik:RadTab Text="AnchorTab" PageViewID="anchorFieldset" Visible="false" Value="AnchorTab">
					</telerik:RadTab>
					<telerik:RadTab Text="EmailTab" PageViewID="emailFieldset" Value="EmailTab">
					</telerik:RadTab>
				</Tabs>
			</telerik:RadTabStrip>
		</td>
